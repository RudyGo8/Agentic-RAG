...
class MilvusWriter:
    ...
    def write_documents(self, file_path: str, filename: str) -> int:
        ...
        for i, doc in enumerate(docs):
            data.append({
                # Milvus 的 text 字段上限是 2000，这里做一次保险截断。
                "text": doc["text"][:2000],
        ...
        # 4. 叶子块 + 双向量一起写入 Milvus，供后续 hybrid search 使用。
